...
public interface ApiService {
    ...
    //user
    @POST("login")
    Call<Login> loginApp(@Query("username") String username,
                         @Query("password") String password);
    @POST("reg")
    Call<Login> regUser(@Body User user,
                        @Query("re_pass") String rePass);
    @GET("info-user")
    Call<InfoUser> getInfoUser(@Query("username") String username);
    // truyện
    @GET("comic")
    Call<GetComic> getListComic(@Query("page") int page,
                                @Query("limit") int limit);
    @GET("comic")
    Call<GetComic> getListPhoto(@Query("page") int page,
                                @Query("limit") int limit);
    @GET("comic/{id}/detail")
    ...
    @PUT("comment/{id}")
    Call<MsgCallApi> putComment(@Path("id") String id,
                                @Query("cmt_new") String cmt);
    @DELETE("comment/{id}")
